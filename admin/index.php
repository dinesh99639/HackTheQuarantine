				...
				<div class="col-sm-3" style="padding: 0;">
					<div class="sidebar">
						<ul>
							...
							<li id="addparticipants" class="sidebar_item">Add Participants</li>
							<li id="managerounds" class="sidebar_item">Manage Rounds</li>
...
$(document).ready(()=>{
	...
	$('.sidebar_item').click(function(event)
	{
		if ($(this).attr("id")!=active_tab)
		{
			...
			{
				$('.page_content').load("update/"+active_tab+".php", ()=>{hide_preloader();});
				localStorage.setItem("page", "update/"+active_tab);
				localStorage.setItem("sidebar_item", active_tab);
			}
		}
